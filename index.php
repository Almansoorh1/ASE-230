...
<head>
    ...
    <title>
      <?php echo 'ASE 230 - class of Spring/Fall/Summer 20XX'; ?>
    </title>
</head>
  <body>
      ...
      <div class="row">
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
              <!-- Team Thumb-->
              <div class="advisor_thumb"><a href="Hamad_Almansoori.php"><img src="https://bootdey.com/img/Content/avatar/avatar1.png" alt=""></a>
                <!-- Social Info-->
                <div class="social-info"><a href="Hamad_Almansoori.php"><i class="fa fa-facebook"></i></a><a href="detail.html"><i class="fa fa-twitter"></i></a><a href="detail.html"><i class="fa fa-linkedin"></i></a></div>
              </div>
              <!-- Team Details-->
              <div class="single_advisor_details_info">
                <h6>
                  <?php echo 'Hamad Almansoori'; ?>
                </h6>
                <p class="designation">
                  <?php echo 'Student'; ?>
                </p>
